...
public class AutoPickCubeTest extends SequentialCommandGroup {
  DriveSubsystem m_chassis;
  Schlucker m_schlucker;
  Arm m_arm;

  public AutoPickCubeTest (DriveSubsystem chassis, Schlucker schlucker, Arm arm) {
    m_chassis = chassis;
    ...
    addCommands(
      ...
      (new WaitCommand(1)),
      (m_chassis.getDriveCommand(new Pose2d(), List.of(), new Pose2d(-3, 0, Rotation2d.fromDegrees(180))))
    );
